...
public class InterfaceSlot extends Slot {
	...
	private boolean highlightBtn1, highlightBtn2, highlightBtn3, highlightBtn4, highlightBtn5, highlightBtn6;
	...
	public UI update(Point pos, Point mousePos, boolean clicked) {
		...
		if (Utility.pointRectInclusion(mousePos, pos.x, pos.y, BTN_WIDTH, HEIGHT)) {
			...
			highlightBtn1 = highlightBtn2 = highlightBtn3 = highlightBtn4 = highlightBtn5 = highlightBtn6 = false;
		}
