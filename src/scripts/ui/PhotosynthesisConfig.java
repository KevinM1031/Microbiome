...
class PhotosynthesisConfigUIFunc {
	...
	public static void slot2_Func1(Returner<String> rtr) {
		double n = 0;
		try {
			n = Math.min(Integer.MAX_VALUE, Math.max(0, Double.parseDouble(rtr.get())));
		} catch(NumberFormatException e) {}
