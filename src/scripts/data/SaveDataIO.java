...
public class SaveDataIO {
	...
	public static void loadSave(LinkedList<Protein> proteins, LinkedList<Spore> spores, 
		...
		try {
			FileReader reader = new FileReader("src/scripts/data/saves/saveDescriptions.txt");
	...
	public static void reloadSave(int index_, boolean updateIndex, 
		...
		// environment
		try {
			FileReader reader = new FileReader("src/scripts/data/saves/save" + index_ + "/environment.txt");
			int raw, i = 0;
			String str = "";
		...
		// proteins
		try {
			FileReader reader = new FileReader("src/scripts/data/saves/save" + index_ + "/proteins.txt");
			int raw, i = 0;
			String str = "", gene = "";
			double x = 0, y = 0, r = 0;
		...
		// spores
		try {
			FileReader reader = new FileReader("src/scripts/data/saves/save" + index_ + "/spores.txt");
			int raw, i = 0;
			String str = "", gene = "";
			double x = 0, y = 0;
		...
		// resources
		try {
			FileReader reader = new FileReader("src/scripts/data/saves/save" + index_ + "/resources.txt");
			int raw, i = 0;
			String str = "";
			double x = 0, y = 0;
			int type = 0, amount = 0;
		...
		// vents
		try {
			FileReader reader = new FileReader("src/scripts/data/saves/save" + index_ + "/vents.txt");
			int raw, i = 0;
			String str = "";
			int amount = 0;
	...
	public static void updateDescriptions() {
		...
		try {
			FileWriter writer = new FileWriter("src/scripts/data/saves/saveDescriptions.txt");
	...
	public static void updateSave(int index_, 
		...
		try {
			FileWriter writer = new FileWriter("src/scripts/data/saves/save" + index_ + "/proteins.txt");
			writer.write(saveData);
			writer.close();
		...
		try {
			FileWriter writer = new FileWriter("src/scripts/data/saves/save" + index_ + "/spores.txt");
			writer.write(saveData);
			writer.close();
		...
		try {
			FileWriter writer = new FileWriter("src/scripts/data/saves/save" + index_ + "/resources.txt");
			writer.write(saveData);
			writer.close();
